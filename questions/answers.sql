-- Part 2a, Question 1
    ...
    SELECT
        ...
        COUNT(li.item_id) AS num_times_in_successful_orders -- num_times_in_successful_orders is generated by counting the number of times an item is found in an order FROM the orders table
